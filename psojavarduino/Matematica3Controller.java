 ...
 * @author DELL
 */
public class Matematica3Controller implements Initializable {
    ...
    public void Voltar() throws IOException{
          ...
          // Parent par = root.load();
            ...
            URL url = getClass().getResource("/psojavarduino/Matematica2.fxml");
    ...
    public void Proxima() throws IOException{
          ...
          // Parent par = root.load();
            ...
            URL url = getClass().getResource("/psojavarduino/PhysicsIntroduction.fxml");
            Parent root = FXMLLoader.load(url);            
