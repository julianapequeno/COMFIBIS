 ...
 * @author DELL
 */
public class PSOGWOController implements Initializable {
    ...
    public void Voltar() throws IOException{
          ...
          // Parent par = root.load();
            ...
            URL url = getClass().getResource("/psojavarduino/TelaSecundaria.fxml");
    ...
    public void PSO() throws IOException{
          ...
          // Parent par = root.load();
            ...
            URL url = getClass().getResource("/psojavarduino/FXMLDocumentTest.fxml");
            Parent root = FXMLLoader.load(url);            
